                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-3 sm:gap-4 text-sm text-gray-600">
                      <div className="flex items-center">
                        <span>{find.client ? `${find.client.firstName} ${find.client.lastName}` : 'Client'} - ₦{parseInt(find.budgetMin || "0").toLocaleString()} - ₦{parseInt(find.budgetMax || "0").toLocaleString()}</span>
                      </div>
                      <div className="flex items-center">
